# AUTOGENERATED! DO NOT EDIT! File to edit: ../notebooks/04_evaluation.ipynb.

# %% auto 0
__all__ = ['calculate_accuracy', 'evaluate']

# %% ../notebooks/04_evaluation.ipynb 1
from sklearn.metrics import accuracy_score, confusion_matrix
import math
import matplotlib.pyplot as plt
import seaborn as sns

# %% ../notebooks/04_evaluation.ipynb 2
def calculate_accuracy(y_test, y_preds):
    accuracy = accuracy_score(y_test, y_preds)
    return accuracy

# %% ../notebooks/04_evaluation.ipynb 3
